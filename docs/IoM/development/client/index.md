---
title: Client 开发指南
description: 本指南介绍如何为IoM的Client组件进行开发和贡献。Client是用户与IoM系统交互的主要界面。
edition: community
generated: false
source: wiki:guideline/develop/client.md
---
...
- [IoM设计文档](/IoM/getting-started/design/) - 了解整体架构
- [Mal插件文档](/IoM/development/mals/) - 插件开发详细指南
- [Server开发指南](/IoM/development/server/) - 服务端开发
- [Armory生态](https://github.com/sliverarmory/armory) - Sliver插件生态

---

[⬅️ 返回开发者指南](/IoM/development/)

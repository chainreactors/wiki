---
title: TypeScript
description: IoM TypeScript SDK 是一个共享的 gRPC 客户端库，用于 VSCode 扩展和 Web 应用开发。
edition: community
generated: false
source: mn:development/sdk/typescript-sdk.md
---
...
对应 [Client 架构](/IoM/user-guide/)，通过 `GrpcClient` 类与 Server 进行 gRPC 通讯。

---
title: Go
description: IoM Go SDK 是 Malice Network 的官方 Golang SDK，提供完整的 gRPC 客户端功能。
edition: community
generated: false
source: mn:development/sdk/go-sdk.md
---
...
对应 [Client 架构](/IoM/user-guide/)，通过 `ServerStatus` 管理与 Server 的 gRPC 连接。

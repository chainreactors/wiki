---
title: Python
description: IoM Python SDK 是一个现代异步客户端库，用于与 Malice Network C2 框架进行交互。
edition: community
generated: false
source: mn:development/sdk/python-sdk.md
---
...
SDK 的设计完全对应 IoM 的架构概念，详细架构说明请参考 [核心概念](/IoM/getting-started/concepts/)。

### Client - 客户端

对应 [Client 架构](/IoM/user-guide/)，SDK 通过 `MaliceClient` 类与 Server 进行 gRPC 通讯。
...
对应 [Session](/IoM/user-guide/console/)，代表一个已连接的 Implant。
...
对应 [Task](/IoM/user-guide/console/)，IoM 使用基于任务的异步执行模型。
...
对应 [核心概念](/IoM/getting-started/concepts/) 中的数据面说明，SDK 自动处理 Spite 的序列化和反序列化。
...
SDK 自动转发所有 133 个 gRPC 方法，对应 [Server RPC](/IoM/development/server/internals/)。
...
- [核心概念](/IoM/getting-started/concepts/)

...
description: Introduce a skill command to the malice-network client that provides
  reusable, template-driven prompt injection for LLM agent sessions. Skills are pre-author...
edition: community
generated: false
source: mn:experiments/proposal-agent-skills.md
---

---
title: 快速开始
description: 本文档说明发布产物、初始化启动、凭证登录和首次构建流程。内容基于当前仓库代码和发布配置。
edition: community
generated: false
source: mn:getting-started.md
---
...
- [server/listeners.md](/IoM/user-guide/listener/)
- [custom-pipeline-guide.md](/IoM/development/server/custom-pipeline/)
...
- Client 命令总览: [client/commands.md](/IoM/reference/commands/client/)
- MAL 插件开发: [development/mal/](/IoM/development/mals/)
- Implant 概览: [implant/overview.md](/malefic/getting-started/architecture/)
- 架构图: [concept.md](/IoM/getting-started/concepts/)

...
![](assets/HVHZbhvyeoATmxx9pvRcIg8XnTh.png)
...
![](assets/QbV9b1QDCozaefxZ46hct89cn1e.png)

`Explorer` 下，文件夹以紫色显示，文件则以白色显示。选中文件夹后，使用方向键右键，则可进入文件夹中。

![](assets/NvV2bq1HtohSbjx6NdLcSUTnnqc.png)

![](assets/E59cbctXjo1r29xWpmYcYNVzn3e.png)

在进入文件夹后，使用方向键左键，则可退回上一级目录。

选中文件后，按下 `d` 键, `Explorer` 会将选中文件下载至服务器，并在终端上，显示下载进度。

![](assets/GIx7bC9xPoA2lrxkL85cavA0nNc.png)

---
title: 构建与 Profile
description: 在IoM中，implant的相关特性是由编译使用的profile决定的。在编译之前首先要准备好需要的profile。
edition: community
generated: false
source: mn:operations/build.md
---
...
!!! tip "TLS 配置"
    ...
    listener的pipeline的tls配置可以在[Listener 操作 - TLS](/IoM/user-guide/listener/)查阅。
...
!!! tip "Encryption 配置"
    关于pipeline的Encryption信息，请参阅[Listener 操作 - Encryption](/IoM/user-guide/listener/)
...
!!! tip "basic 配置"
    有关basic配置的更多信息，请参阅 [构建操作](/IoM/user-guide/build/)
...
在编译prelude和beacon类型的implant时，`autorun` 字段用于指定 implant 上线时自动执行的配置文件 autorun.yaml，详细的autorun在 [构建操作](/IoM/user-guide/build/)中有说明。
```yaml
implants:
...
!!! tip "implant 配置"
    有关implant配置的更多信息，请参阅 [构建操作](/IoM/user-guide/build/)
...
!!! tip "build 配置"
    `build` 部分的ollvm混淆拥有多种设置，也设置更多的自定义元信息字段。有关更多build的配置信息，请参阅 [构建操作](/IoM/user-guide/build/)。
...
!!! tip "核心概念"
    有关implant的简单介绍可以查看[核心概念](/IoM/getting-started/concepts/)
...
!!! tip "更多编译选项"
    更多有关 `build beacon` 命令的编译选项，请参阅 [构建操作](/IoM/user-guide/build/)
...
!!! tip "更多编译选项"
    更多有关 `build pulse` 命令的编译选项，请参阅 [构建操作](/IoM/user-guide/build/)
...
详细的zip压缩格式在[构建操作](/IoM/user-guide/build/)中说明。
编译命令如下：
```bash
...
!!! tip "更多编译选项"
    更多有关 `build prelude` 命令的编译选项，请参阅 [构建操作](/IoM/user-guide/build/)
...
!!! tip "更多编译选项"
    更多有关 `build modules` 命令的编译选项，请参阅 [构建操作](/IoM/user-guide/build/)
...
```
!!! tip "artifact 下载格式"
    更多的format格式， 请参阅[构建操作](/IoM/user-guide/build/)

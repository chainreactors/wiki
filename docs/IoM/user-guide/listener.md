...
description: Listener 是 IoM 中的分布式监听服务 ，负责与 Implant 建立和维持实际的通信。
edition: community
generated: false
source: mn:operations/listener.md
---
...
> **Tip:**
    具体架构在[Listener 架构](/IoM/user-guide/listener/)查看
...
> **Tip:**
    具体架构在[Listener 操作](/IoM/user-guide/listener/)查看
...
> **Tip:** "tcp命令"
    关于tcp命令的更多使用方法，请查阅[命令参考](/IoM/reference/commands/client/)
...
> **Tip:** "http命令"
    关于http命令的更多使用方法，请查阅[命令参考](/IoM/reference/commands/client/)

在gui中，可以在listener界面中点击new pipeline，选择pipeline type为http后添加。
![image-2025081725224752](../assets/usage/listener/http_new_gui.png)

> **Tip:** 
     pipeline是和implant相互通信的，所以两者配置需要相互匹配，implant的tcp和http配置在[构建操作](/IoM/user-guide/build/)查看。
#### website
...
> **Tip:** "website命令"
    关于website命令的更多使用方法，请查阅[命令参考](/IoM/reference/commands/client/)
...
> **Tip:** "rem指南" 
    ...
    关于在 implant 中如何使用 **rem** ，可参考 [rem_usage](/IoM/user-guide/advanced/proxy/)。
#### bind (Unstable)
...
> **Tip:** "tls指南" 
    当您打开tls配置时，您需要确保Implant的tls配置也打开，implant的tls配置请在[构建操作](/IoM/user-guide/build/)参阅。
    listener上的tls具体配置可以在[Listener 操作](/IoM/user-guide/listener/)查看。
### Parser
...
> **Tip:** "parser指南"
    具体Parser配置可以在[Listener 操作](/IoM/user-guide/listener/)查看。
### Encryption
...
> **Tip:** "encryption指南" 
    具体Encryption配置可以在[Listener 操作](/IoM/user-guide/listener/)查看。
    如何在Implant上配置对应的Encryption，请在[Listener 操作 - Encryption](/IoM/user-guide/listener/)查看。
### http自定义响应内容

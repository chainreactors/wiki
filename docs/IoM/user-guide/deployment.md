---
title: 部署指南
description: 本文档说明 Server 和 Client 的部署方式。
edition: community
generated: false
source: mn:operations/deployment.md
---
...
Listener 和编译配置详见 [listeners.md](/IoM/user-guide/listener/) 和 [build.md](/IoM/user-guide/build/)。
...
- 快速开始: [getting-started.md](/IoM/getting-started/)
- Listener 配置: [server/listeners.md](/IoM/user-guide/listener/)
- 构建配置: [server/build.md](/IoM/user-guide/build/)

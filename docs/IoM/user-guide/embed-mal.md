---
title: 内置 MAL 操作
description: '在 IoM 的 v0.1.1 中集成了一系列内置的 embed 功能: !malintlhelp.png'
edition: community
generated: false
source: mn:operations/embed-mal.md
---
...
完整的 Lua API 参考见 [Reference / Lua API](/IoM/reference/lua-api/builtin/)。
...
![img_9.png](../assets/embed/usage/nanodump.png)

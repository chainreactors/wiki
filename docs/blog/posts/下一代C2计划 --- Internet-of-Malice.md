...
现在可以在 [IoM roadmap](/IoM/getting-started/roadmap/) 中找到我们的具体计划与路线图.
...
可以在这里快速开始尝试IoM: /IoM/getting-started/
### 防止滥用
...
目前提供了IoM的[设计文档](/IoM/getting-started/design)与[用户手册](/IoM/getting-started) ,可以在[这里](https://github.com/chainreactors/malice-network)体验到IoM的v0.0.1
...
目前提供了rem的[设计文档](/rem/design) 与 [路线图](/rem/changelog/)
